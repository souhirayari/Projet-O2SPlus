...
function UpdateUser({ show, handleClose, user }) {
                        ...
                        <Form>
                            ...
                            <Row className="mb-3">
                                <Form.Group as={Col} controlId="formGridCodeUser">
                                    ...
                                    <Form.Control type="text" name='codeUser' onChange={handleChange} value={formData.codeUser} placeholder="Enter Code User" required />
                                </Form.Group>
